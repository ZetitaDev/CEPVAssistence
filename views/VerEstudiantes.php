    ...
    <?php if ($result->num_rows > 0): ?>
        <?php while ($row = $result->fetch_assoc()): ?>
            <tr>
                ...
                <td>
                    <!-- Botón Editar -->
                    <a href="EditarEstudiante.php?id=<?php echo $row['id']; ?>" class="btn btn-sm btn-primary">
                        <i class="fas fa-edit"></i> Editar
                    </a>
                    <!-- Botón Eliminar -->
                    <button onclick="eliminarEstudiante(<?php echo $row['id']; ?>)" class="btn btn-sm btn-danger">
